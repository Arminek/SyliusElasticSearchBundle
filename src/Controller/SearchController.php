...
final class SearchController
{
    ...
    public function filterAction(Request $request)
    {
        ...
        $form = $this->formFactory->create(FilterSetType::class, Criteria::fromQueryParameters($this->getResourceClassFromRequest($request), []), ['filter_set' => $this->getFilterSetFromRequest($request)]);
